...
// Constantes
const int AirValue = 3100;    // Sensor capacitivo en el aire
const int WaterValue = 1350;  // Sensor capacitivo en agua
...
void enter_sleep()
{
    ...
    oled.drawString(oled.getWidth() / 2, oled.getHeight() / 2, "Moisture: " + String(moisture) + "%");
    oled.display();
    delay(2000);
    oled.clear();
    oled.display();
